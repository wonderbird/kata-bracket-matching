...
namespace csharp.Lib.Tests
{
    public class BalancedStringValidatorTest
    {
        ...
        [InlineData(true, "[Sensei says yes!]", "[]")]
        [InlineData(false, "[Sensei says no!", "[]")]
        public void IsBalanced_SingleParentheses_ReturnsExpectedResult(bool expectation, string input, string balancingCharacterPairs)
        {
        ...
        public void IsBalanced_DataFromCodeWars_ExpectedResultFromCodewars(bool expectation, string input, string balancingCharacterPairs)
        {
            Assert.Equal(expectation, input.IsBalanced(balancingCharacterPairs));
        }
    }
